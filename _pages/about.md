...
**① 실험 비교 데모** — Base RAG vs Conflict-Aware Prompting

같은 질문을 두 Config로 실행해 응답 차이를 직접 비교해보세요.
추천: _"What color is the Northwood Institute mascot after the 2019 revision?"_ — Base RAG는 내부 지식(deep blue), Conflict-Aware는 검색 문서 우선(silver-green)으로 답합니다.

<a href="https://huggingface.co/spaces/ponyo03/conflict-aware-rag-demo" target="_blank" rel="noopener" style="display:inline-block;background:linear-gradient(135deg,#667eea,#764ba2);color:white;font-weight:700;padding:0.5rem 1.5rem;border-radius:999px;text-decoration:none;margin:0.5rem 0;">🚀 웹 데모 열기</a>

---

**② 저장소 문서 RAG 챗봇** — Telegram Bot

GitHub 저장소의 README · docs · CLAUDE.md를 지식베이스로 청킹·임베딩한 뒤, 벡터 검색으로 관련 문맥을 찾아 Claude가 답변하는 RAG 챗봇입니다. 저장소 구조, 실행 방법, 연구 내용 등을 질문해보세요.

<a href="https://t.me/alltology_rag_bot" target="_blank" rel="noopener" style="display:inline-block;background:#29B6F6;color:white;font-weight:700;padding:0.5rem 1.5rem;border-radius:999px;text-decoration:none;margin:0.5rem 0;">✈️ 텔레그램 봇 열기</a>
